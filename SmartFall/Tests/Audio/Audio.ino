 ...
 *
 * Wiring:
 * - PAM8302 A+ → ESP32 GPIO 13 (PWM output, pin A12)
 * - PAM8302 A- → GND
 * - PAM8302 Vin → 3.3V or USB (5V)
 * - PAM8302 GND → GND
 * - Speaker (4-8Ω) → PAM8302 OUT+ and OUT- terminals
 *
 * This test verifies:
 * - PWM tone generation
...
void setup()
{
    ...
    if (audioManager.begin())
    {
        ...
        Serial.println("✓ PWM configured on GPIO 13 (pin A12)");
 ...
 *
 * No sound at all:
 * - Check PAM8302 wiring (A+ to GPIO13, GND to GND, Vin to 3.3V/5V)
 * - Verify speaker is connected to PAM8302 OUT+ and OUT- terminals

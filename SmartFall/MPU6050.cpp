...
MPU6050Sensor::MPU6050Sensor(uint8_t sda, uint8_t scl)
...
void MPU6050Sensor::configure(mpu6050_accel_range_t accel_range,
...
bool MPU6050Sensor::readData(float &accel_x, float &accel_y, float &accel_z,
...
bool MPU6050Sensor::isCalibrated()
{
    return calibrated;
}

bool MPU6050Sensor::isInitialized()
{
    return initialized;
}

void MPU6050Sensor::printInfo()
{
    if (!initialized)
    {

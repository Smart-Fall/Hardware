...
MAX30102_Sensor::MAX30102_Sensor(uint8_t rx, uint8_t tx)
...
bool MAX30102_Sensor::begin(uint8_t address)
{
    #ifdef MAX30102_USE_UART
        // Initialize UART
...
void MAX30102_Sensor::configure()
{
    if (!initialized)
        return;
...
bool MAX30102_Sensor::readData(uint16_t &heart_rate, uint8_t &spo2, float &temperature)
{
    if (!initialized)
        return false;
...
bool MAX30102_Sensor::getRawData(uint16_t &heart_rate, uint8_t &spo2)
{
    if (!initialized)
        return false;
...
float MAX30102_Sensor::getTemperature()
{
    if (!initialized)
        return -1.0f;
...
void MAX30102_Sensor::setBaselineHeartRate(uint16_t baseline)
{
    baseline_heart_rate = baseline;
    baseline_set = true;
}

void MAX30102_Sensor::setBaselineSPO2(uint8_t baseline)
{
    baseline_spo2 = baseline;
}

uint16_t MAX30102_Sensor::getBaselineHeartRate()
{
    return baseline_heart_rate;
}

uint8_t MAX30102_Sensor::getBaselineSPO2()
{
    return baseline_spo2;
}

void MAX30102_Sensor::resetBaseline()
{
...
void MAX30102_Sensor::startCollection()
{
    if (!initialized)
        return;
...
void MAX30102_Sensor::stopCollection()
{
    if (!initialized)
        return;

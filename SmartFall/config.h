...
// I2C Bus (SCL=GPIO20, SDA=GPIO22)
#define MPU6050_SDA_PIN            22    // I2C Data
#define MPU6050_SCL_PIN            20    // I2C Clock
#define BMP280_SDA_PIN             22    // I2C Data (shared)
#define BMP280_SCL_PIN             20    // I2C Clock (shared)
#define MAX30102_SDA_PIN           22    // I2C Data (shared)
#define MAX30102_SCL_PIN           20    // I2C Clock (shared)
#define MAX30102_RST_PIN           21    // MAX30102 Hardware Reset (active LOW) - Connected to MI pin
...
#define SPEAKER_PIN                25    // Audio alert output (GPIO 25, DAC1)
#define HAPTIC_PIN                 26    // Haptic motor control (GPIO 26, A0/DAC2)
#define VISUAL_ALERT_PIN           27    // Visual alert LED
#define BATTERY_SENSE_PIN          A4    // Battery voltage monitoring (GPIO 36, ADC1 - WiFi safe)

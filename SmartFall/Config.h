...
// Algorithm thresholds (tuned for light-fall sensitivity)
#define FREEFALL_THRESHOLD_G 0.7f
#define IMPACT_THRESHOLD_G 1.3f
#define ROTATION_THRESHOLD_DPS 100.0f
#define INACTIVITY_THRESHOLD_MS 1400
#define FREEFALL_MIN_DURATION_MS 120
#define STAGE1_EXIT_DEBOUNCE_MS 40
#define IMPACT_MAX_DELAY_MS 2000
#define STAGE2_HOLD_MS 120
#define STAGE4_EXIT_DEBOUNCE_MS 500
#define POTENTIAL_FALL_EXIT_DEBOUNCE_MS 800
#define POTENTIAL_FALL_SOFT_EXIT_DEBOUNCE_MS 1800
#define INACTIVITY_RECOVERY_ACCEL_G 1.2f
#define INACTIVITY_RECOVERY_ANGULAR_DPS 70.0f
#define POTENTIAL_RECOVERY_ACCEL_G 1.4f
#define POTENTIAL_RECOVERY_ANGULAR_DPS 90.0f
...
#define CONFIRMED_THRESHOLD 45
#define POTENTIAL_THRESHOLD 30

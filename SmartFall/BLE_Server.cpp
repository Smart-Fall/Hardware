...
void BLE_Server::CommandCallbacks::onWrite(BLECharacteristic* characteristic) {
    ...
    if (value.length() > 0) {
        ...
        uint8_t* data = (uint8_t*)value.c_str() + 1;
...
String BLE_Server::createStatusJSON(const SystemStatus_t& data) {
    ...
    // Convert FallStatus_t enum to human-readable string
    const char* statusStr = "UNKNOWN";
    switch (data.current_status) {
        case FALL_STATUS_MONITORING:         statusStr = "MONITORING";         break;
        case FALL_STATUS_STAGE1_FREEFALL:    statusStr = "STAGE1_FREEFALL";    break;
        case FALL_STATUS_STAGE2_IMPACT:      statusStr = "STAGE2_IMPACT";      break;
        case FALL_STATUS_STAGE3_ROTATION:    statusStr = "STAGE3_ROTATION";    break;
        case FALL_STATUS_STAGE4_INACTIVITY:  statusStr = "STAGE4_INACTIVITY";  break;
        case FALL_STATUS_POTENTIAL_FALL:     statusStr = "POTENTIAL_FALL";     break;
        case FALL_STATUS_FALL_DETECTED:      statusStr = "FALL_DETECTED";      break;
        case FALL_STATUS_EMERGENCY_ACTIVE:   statusStr = "EMERGENCY_ACTIVE";   break;
    }
